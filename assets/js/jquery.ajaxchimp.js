...
(function ($) {
    ...
    $.fn.ajaxChimp = function (options) {
        $(this).each(function(i, elem) {
            ...
            var spanMessage = form.find('span')
            ...
            form.submit(function () {
                ...
                function successCallback(resp) {
                    ...
                    window.setTimeout(function() {
                      ...
                      spanMessage.removeClass('visible').removeClass('failure').removeClass('success');
...
$('#signup-form').ajaxChimp({
    url: 'https://withmadico.us19.list-manage.com/subscribe/post?u=6f4999131288a850ad71d6e54&amp;id=c75cd847f2'
});
